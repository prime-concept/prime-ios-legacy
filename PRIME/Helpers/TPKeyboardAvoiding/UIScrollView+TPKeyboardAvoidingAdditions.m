...
@property (nonatomic, assign, getter=isPriorPagingEnabled) BOOL priorPagingEnabled;
@property (nonatomic, assign, getter=isIgnoringNotifications) BOOL ignoringNotifications;
@end
...
- (void)TPKeyboardAvoiding_keyboardWillShow:(NSNotification*)notification
{
    ...
    if (state.isIgnoringNotifications && state.isKeyboardVisible) {
        return;
    }
...
- (void)TPKeyboardAvoiding_keyboardWillHide:(NSNotification*)notification
{
    ...
    self.pagingEnabled = state.isPriorPagingEnabled;
    [self layoutIfNeeded];
    [UIView commitAnimations];
}
...
- (void)TPKeyboardAvoiding_shouldIgnoreNotifications:(BOOL)shouldIgnoreNotifications
{
    [[self keyboardAvoidingState] setIgnoringNotifications:shouldIgnoreNotifications];
}
...
{
    if ([self TPKeyboardAvoiding_viewHiddenOrUserInteractionNotEnabled:view]) {
        return NO;
    }
