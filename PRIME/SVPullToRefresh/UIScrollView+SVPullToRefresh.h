...
typedef NS_ENUM(NSUInteger, SVPullToRefreshPosition) {
    SVPullToRefreshPosition_Top,
    SVPullToRefreshPosition_Bottom,
};
...
typedef NS_ENUM(NSUInteger, SVPullToRefreshState) {
    SVPullToRefreshState_Stopped = 0,
    SVPullToRefreshState_Triggered,
    SVPullToRefreshState_Loading,
    SVPullToRefreshState_All = 10
};
