...
{
    //Pond Mobile.
    kClientID = @"brxwmnt9w1tpql89h6g30svw9";
    kClientSecret = @"8iwa6xat02xi14f1wnxhdibxd";
    kTargetName = @"pondmobile";
    kURLSchemesPrefix = [NSString stringWithFormat:@"%@://", kTargetName];
    kUserDefaultsSuiteName = @"group.com.prime.app.pondmobile";
    ...
    kWelcomeScreenBackgroundColor = [UIColor colorWithRed:75. / 255 green:56. / 255 blue:50. / 255 alpha:1];
    ...
    kTabBarUnselectedTextColor = [UIColor colorWithRed:136. / 255 green:107. / 255 blue:99. / 255 alpha:1];
    kTabBarDayLabelUnselectedTextColor = [UIColor colorWithRed:136. / 255 green:107. / 255 blue:99. / 255 alpha:1];
    ...
    kTabItem2Image = [[UIImage imageNamed:@"tabIcon2Selected"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    ...
    kClubInfoVCLine3LabelText = @"is not found in the list of PRIME Pond mobile concierge-service\n";
    kAppMainColor = @"#F241B";
