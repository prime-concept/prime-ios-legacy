...
+ (void)load
{
    kClientID = @"cb6yexaek3bpca70m2gi0qun2";
    kClientSecret = @"98r2zuiskzvcy4hchonwd6hfa";
    kTargetName = @"pdavidoff";
    kURLSchemesPrefix = [NSString stringWithFormat:@"%@://", kTargetName];
    kUserDefaultsSuiteName = @"group.com.prime.app.davidoff";
    kClubPhoneNumber = @"+79636464400";
    kLoginWithCardText = @"To use the application please enter your card number of Davidoff Club PRIME";
    kMonthsCollectionViewArrowColor = [UIColor colorWithRed:209. / 255 green:200. / 255 blue:203. / 255 alpha:1];
    kIconsColor = kDavidoffMainColor;
    kBadgeColor = kDavidoffMainColor;
    kSegmentedControlTaskStatusColor = kLightBrownColor;
    kTaskSegmentColor = kDavidoffMainColor;
    kReservesOrRequestsSegmentColor = kDavidoffMainColor;
    kTabBarBackgroundColor = [UIColor colorWithRed:63. / 255 green:36. / 255 blue:27. / 255 alpha:1];
    kCalendarTodayTextColor = [UIColor colorWithRed:237. / 255 green:29. / 255 blue:36. / 255 alpha:1];
    kNavigationBarTintColor = kDavidoffMainColor;
    ...
    kWelcomeScreenNextButtonColor = kDavidoffMainColor;
    kContainerButtonColor = kAppColor;
    kCalendarEventLineColor = [UIColor colorWithRed:238. / 255 green:57. / 255 blue:35. / 255 alpha:1];
    kCalendarTodayCircleColor = kDavidoffMainColor;
    kCalendarSelectedDayCircleColor = kDavidoffMainColor;
    kCalendarTodayButtonColor = kLightBrownColor;
    kCalendarSelectedDayTextColor = [UIColor whiteColor];
    kPayButtonBackgroundColor = kDavidoffMainColor;
    kMonthColor = kAppColor;
    kTabBarDayLabelUnselectedTextColor = [UIColor colorWithRed:63. / 255 green:36. / 255 blue:27. / 255 alpha:1];
    kTabBarSelectedTextColor = kWhiteColor;
    kTabBarUnselectedTextColor = [UIColor colorWithRed:94. / 255 green:65. / 255 blue:61. / 255 alpha:1];
    ...
    kReceiveVirtualCardBackgroundColor = kDavidoffMainColor;
    ...
    kClubInfoVCLine3LabelText = @"is not recognized by the Concierge-service PRIME Davidoff\n";
    ...
    kAttachCancelColor = kDavidoffMainColor;
