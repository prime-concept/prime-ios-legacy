...
{
    //Prime.
    kClientID = @"d49dibsiw7r0c0jsopfiqobqo";
    kClientSecret = @"a2sp0ee24y7vqbc46c0ta4mza";
    kTargetName = @"privatebanking";
    kURLSchemesPrefix = [NSString stringWithFormat:@"%@://", kTargetName];
    kUserDefaultsSuiteName = @"group.com.prime.app.privatebanking";
    kClubPhoneNumber = @"+74955395937";
    ...
    kLoginWithCardText = @"To use the application please enter your card number of Private Banking.";
    kSegmentedControlTaskStatusColor = kLightBrownColor;
    kTaskSegmentColor = kGazprombankMainColor;
    kReservesOrRequestsSegmentColor = kWhiteColor;
    kTabBarBackgroundColor = kGazprombankMainColor;
    kCalendarTodayTextColor = [UIColor colorWithRed:237. / 255 green:29. / 255 blue:36. / 255 alpha:1];
    kNavigationBarTintColor = kWhiteColor;
    ...
    kWelcomeScreenNextButtonColor = [UIColor colorWithRed:94. / 255 green:97. / 255 blue:103. / 255 alpha:1];
    ...
    kTabBarDayLabelUnselectedTextColor = [UIColor colorWithRed:45. / 255 green:47. / 255 blue:54. / 255 alpha:1];
    kTabBarSelectedTextColor = kWhiteColor;
    kTabBarUnselectedTextColor = kWelcomeScreenNextButtonColor;
    ...
    kTypingContainerViewColor = [UIColor colorWithRed:216. / 255 green:216. / 255 blue:216. / 255 alpha:1];
    ...
    kNavigationBarBarTintColor = [UIColor colorWithRed:45. / 255 green:47. / 255 blue:54. / 255 alpha:1];
    kPhoneLabelTextColor = [UIColor blackColor];
    kWeChatImageColor = [UIColor clearColor];
    kNavigationBarTitleColor = kWhiteColor;
    kClubViewLabelBackgroundColor = [UIColor whiteColor];
    kClubViewLabelColor = [UIColor colorWithRed:155. / 255 green:155. / 255 blue:155. / 255 alpha:1];
    ...
    kTasksHeaderColor = kWhiteColor;
    kChatTaskIconTextColor = kTabBarUnselectedTextColor;
    kChatSendButtonColor = [UIColor colorWithRed:0.71 green:0.61 blue:0.44 alpha:1.0];
    kChatStatusReadColor = [UIColor whiteColor];
    kReceiveVirtualCardBackgroundColor = kGazprombankMainColor;
    ...
    kCityGuideBaseUtm = @"";
    kClubEmail = @"Gazprombank_PrivateBanking@Primeconcierge.ru";
    ...
    kClubInfoVCLine3LabelText = @"is not recognized by the Concierge-service Private Banking PRIME Club\n";
    kAppMainColor = @"B29A6D";
