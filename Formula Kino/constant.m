...
{
    //Formula Kino.
    kClientID = @"e9vhldbl6fl0m2figs7txf6z7";
    kClientSecret = @"4t6mqaftm22t6ihjcy17dor9l";
    kTargetName = @"formulakino";
    kURLSchemesPrefix = [NSString stringWithFormat:@"%@://", kTargetName];
    kUserDefaultsSuiteName = @"group.com.prime.app.formulakino";
    ...
    kClubInfoVCLine3LabelText = @"Is not found in the list of concierge-service users.\nThe application is available for owners of loyalty cards PRIME Formula Kino.\nYou can purchase a card at the cinema PRIME Formula Kino in the \"European\" shopping mall on the 3rd floor,\narea of the Kiev Railway Station, 2, Moscow,\nTechnical support phone \n+ 7 495 641 34 56.";
