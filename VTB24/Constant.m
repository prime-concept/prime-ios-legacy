...
+ (void)load
{
    kClientID = resolve(@"7am01deoxojx0ljcvlbiltyl8", @"VlRCIENsaWVudA==");
    kClientSecret = resolve(@"d44cef05d9zj90zmkanfu8xdb", @"VlRCIENsaWVudCBQYXNzXzEyM0A=");
    kTargetName = @"primeconcierge";
    kURLSchemesPrefix = [NSString stringWithFormat:@"%@://", kTargetName];
    kUserDefaultsSuiteName = @"group.com.prime.app.PrimeConcierge";
    kClubPhoneNumber = @"+74955040900";
    kMonthsCollectionViewArrowColor = kVTBGreyColor;
    kIconsColor = kVTBGoldColor;
    kSegmentedControlTaskStatusColor = kWhiteColor;
    kTaskSegmentColor = kWhiteColor;
    kReservesOrRequestsSegmentColor = kWhiteColor;
    kTabBarBackgroundColor = kVTBMilkColor;
    kCalendarTodayTextColor = kVTBGoldColor;
    kNavigationBarTintColor = kVTBGoldColor;
    kDeleteButtonColor = kVTBGoldColor;
    kProfileInfoNameColor = kVTBGoldColor;
    kWelcomeScreenBackgroundColor = [UIColor colorWithRed:18. / 255 green:18. / 255 blue:17. / 255 alpha:1];
    kWelcomeScreenNextButtonColor = kWhiteColor;
    kContainerButtonColor = kVTBGoldColor;
    kCalendarEventLineColor = kVTBGoldColor;
    kCalendarTodayCircleColor = [UIColor redColor];
    kCalendarSelectedDayCircleColor = kVTBGoldColor;
    kCalendarTodayButtonColor = kVTBGoldColor;
    kCalendarSelectedDayTextColor = [UIColor whiteColor];
    kMonthColor = [UIColor colorWithRed:83. / 255 green:83. / 255 blue:90. / 255 alpha:1];
    kTabBarDayLabelUnselectedTextColor = kWhiteColor;
    kTabBarSelectedTextColor = kVTBGoldColor;
    kTabBarUnselectedTextColor = kVTBDarkGreyColor;
    kPhoneLabelBackgroundColor = kVTBBlackColor;
    ...
    kChatSendTextColor = kVTBDarkGreyColor;
    kPayButtonBackgroundColor = kVTBGoldColor;
    kChatTextViewTintColor = kVTBGoldColor;
    kBadgeColor = kVTBGoldColor;
    kPayButtonTextColor = kWhiteColor;
    kTasksHeaderColor = [UIColor whiteColor];
    kChatLeftTimeLabelTextColor = [UIColor colorWithRed:137. / 255 green:137. / 255 blue:135. / 255 alpha:1];
    kChatRightTimeLabelTextColor = [UIColor colorWithRed:217. / 255 green:210. / 255 blue:196. / 255 alpha:1];
    ...
    kReceiveVirtualCardBackgroundColor = kVTBMilkColor;
    ...
    kCityGuideBaseUtm = @"utm_source=prime_vtb&utm_medium=mobile_application&utm_campaign=prime_travel_user_landing_from_app_integrated";
    kAssistantCellHeight = CGFLOAT_MIN;
    kPersonalContactsSectionHeaderHeight = CGFLOAT_MIN;
    kClubEmail = @"info@prime-concierge.ru";

    kChatTypingTextViewPlaceholderText = @"Type message...";
    kNoRequestsLabelTitle = @"No requests";
    kClubInfoVCInfoLabelText = @"";
    kClubInfoVCLine3LabelText = @"is not found in the list of Prime Concierge concierge-service\n";
    kAppMainColor = @"D4B572";
    kInformationBackgroundColor = [UIColor colorWithRed:0.00 green:0.00 blue:0.00 alpha:1.0];
    ...
    kUberActionSheetTopPartColor = kVTBGoldColor;
    //Appearance
    [[UITextField appearance] setTintColor:kVTBGoldColor];
    [[UITextView appearance] setTintColor:kVTBGoldColor];
}
