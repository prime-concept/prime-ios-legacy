...
Feature: My profile : Family partners : Family personal data : Add family contact

    Description -
        The "2_edit_delete_family.feature" test has dependency from this feature.
        Following fields are tested in this test "last name", "first namke", "middle name", "date of birth", "type contact".


    @reset
    Scenario: Add family/Personal data in My profile
        ...
        Then I pick a "child" from list
        Then I press "Select"
        Then I wait to see text "child"
