...
{
    //Platinum.
    kClientID = @"6y7j7mk4idqmugp4d4rckfanf";
    kClientSecret = @"9r8cqxs6u1en4uhpj48bax3yl";
    kTargetName = @"primeplatinum";
    kURLSchemesPrefix = [NSString stringWithFormat:@"%@://", kTargetName];
    kUserDefaultsSuiteName = @"group.com.prime.app.platinum";
    kClubPhoneNumber = @"+74957925655";
    kMonthsCollectionViewArrowColor = kAeroflotDarkGrayColor;
    kIconsColor = kAeroflotRedColor;
    kSegmentedControlTaskStatusColor = kAeroflotBlackColor;
    kTaskSegmentColor = kAeroflotBlackColor;
    kReservesOrRequestsSegmentColor = kAeroflotBlackColor;
    kTabBarBackgroundColor = kAeroflotBlackColor;
    kCalendarTodayTextColor = kAeroflotRedColor;
    kNavigationBarTintColor = kAeroflotBlackColor;
    kDeleteButtonColor = [UIColor redColor];
    kProfileInfoNameColor = kAeroflotRedColor;
    kPayButtonBackgroundColor = kAeroflotRedColor;
    kWelcomeScreenBackgroundColor = kAeroflotWhiteColor;
    kWelcomeScreenNextButtonColor = kAeroflotWhiteColor;
    kContainerButtonColor = kAppColor;
    kCalendarEventLineColor = kAeroflotRedColor;
    kCalendarTodayCircleColor = kAeroflotBlackColor;
    kCalendarSelectedDayCircleColor = kAeroflotBlackColor;
    kCalendarTodayButtonColor = kAeroflotBlackColor;
    kCalendarSelectedDayTextColor = [UIColor whiteColor];
    kMonthColor = kAeroflotBlackColor;
    kTabBarSelectedTextColor = kAeroflotWhiteColor;
    kTabBarUnselectedTextColor = kAeroflotDarkGrayColor;
    kTabBarDayLabelUnselectedTextColor = kAeroflotDarkGrayColor;
    ...
    kTypingContainerViewColor = kAeroflotDarkGrayColor;
    kTaskPriceTextColor = kAeroflotBlackColor;
    kTableViewBackgroundColor = [UIColor colorWithRed:239. / 255 green:239. / 255 blue:244. / 255 alpha:1];
    kProfileImageTextColor = kAeroflotWhiteColor;
    kChatTitleColor = kAeroflotBlackColor;
    kChatTextViewTintColor = kAeroflotBlackColor;
    kNavigationBarBarTintColor = [UIColor colorWithRed:249. / 255 green:249. / 255 blue:249. / 255 alpha:1];
    kPhoneLabelTextColor = kAeroflotBlackColor;
    ...
    kClubViewLabelColor = kAeroflotBlackColor;
    kClubViewButtonColor = kAeroflotRedColor;
    kChatLeftMessageTextColor = kAeroflotBlackColor;
    kChatRightMessageTextColor = kAeroflotWhiteColor;
    ...
    kChatLeftBalloonImageViewColor = [UIColor colorWithRed:242. / 255 green:242. / 255 blue:242. / 255 alpha:1];
    kChatBalloonImageViewColor = kAeroflotDarkGrayColor;
    kBadgeColor = kAeroflotRedColor;
    kChatSendButtonColor = [UIColor colorWithRed:0.71 green:0.61 blue:0.44 alpha:1.0];
    kChatStatusReadColor = [UIColor whiteColor];
    kReceiveVirtualCardBackgroundColor = kAeroflotBlackColor;
    kReceiveVirtualCardTitleTextColor = kWhiteColor;

    kProfileTableViewBackgroundColor = kAeroflotWhiteColor;
    kChatSendTextColor = kAeroflotRedColor;
    ...
    kTabItem5Title = @"Me";
    kCityGuideBaseUrl = @"https://aeroflot-traveller.concierge.ru/";
    kCityGuideBaseUtm = @"";
    kClubEmail = @"vip@aeroflot.ru";
    ...
    kAppMainColor = @"000000";
    kInformationBackgroundColor = [UIColor colorWithRed:0. / 255 green:0. / 255 blue:0. / 255 alpha:1];
