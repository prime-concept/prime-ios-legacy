...
{
    //Skolkovo.
    kClientID = @"9lyg2x2h1qrztlwef43huqy66";
    kClientSecret = @"5yrbgbv2vmeeps3zaz5hd6yu2";
    kTargetName = @"skolkovo";
    kURLSchemesPrefix = [NSString stringWithFormat:@"%@://", kTargetName];
    kUserDefaultsSuiteName = @"group.com.prime.app.skolkovo";
    kClubPhoneNumber = @"+74956413456";
    kMonthsCollectionViewArrowColor = [UIColor colorWithRed:209. / 255 green:200. / 255 blue:203. / 255 alpha:1];
    kIconsColor = kSkolkovoLightGreenColor;
    kSegmentedControlTaskStatusColor = kSkolkovoLightGreenColor;
    kTaskSegmentColor = kSkolkovoMainColor;
    kReservesOrRequestsSegmentColor = kSkolkovoMainColor;
    kTabBarBackgroundColor = kSkolkovoMainColor;
    kCalendarTodayTextColor = kSkolkovoLightGreenColor;
    kCalendarTodayCircleColor = kSkolkovoLightGreenColor;
    kCalendarSelectedDayCircleColor = kSkolkovoLightGreenColor;
    kCalendarSelectedDayTextColor = [UIColor whiteColor];
    kNavigationBarTintColor = kSkolkovoLightGreenColor;
    kDeleteButtonColor = [UIColor redColor];
    kProfileInfoNameColor = kSkolkovoLightGreenColor;
    kWelcomeScreenBackgroundColor = kSkolkovoMainColor;
    kWelcomeScreenNextButtonColor = kWhiteColor;
    kContainerButtonColor = kSkolkovoMainColor;
    kCalendarEventLineColor = kSkolkovoLightGreenColor;
    kCalendarTodayButtonColor = kSkolkovoLightGreenColor;
    kMonthColor = kSkolkovoMainColor;
    kPayButtonBackgroundColor = kSkolkovoLightGreenColor;
    kTabBarSelectedTextColor = kWhiteColor;
    kTabBarUnselectedTextColor = kSkolkovoWhiteColor;
    kTabBarDayLabelUnselectedTextColor = kSkolkovoWhiteColor;
    ...
    kTaskPriceTextColor = kSkolkovoMainColor;
    ...
    kChatTitleColor = kSkolkovoLightGreenColor;
    kChatTextViewTintColor = kSkolkovoLightGreenColor;
    kChatBalloonImageViewColor = kSkolkovoWhiteColor;
    ...
    kWeChatImageColor = kSkolkovoLightGreenColor;
    ...
    kClubViewButtonColor = kSkolkovoLightGreenColor;
    ...
    kChatSendTextColor = kSkolkovoLightGreenColor;
    kChatLeftTimeLabelTextColor = kSkolkovoLightGreenColor;
    kChatRightTimeLabelTextColor = [UIColor blackColor];
    kRightVoiceMessageDurationLabelTextColor = [UIColor blackColor];
    kLeftVoiceMessageDurationLabelTextColor = kSkolkovoLightGreenColor;
    kChatTaskIconTextColor = kSkolkovoMainColor;
    kBadgeColor = kSkolkovoLightGreenColor;
    kChatSendButtonColor = [UIColor colorWithRed:0.71 green:0.61 blue:0.44 alpha:1.0];
    kReceiveVirtualCardBackgroundColor = kSkolkovoMainColor;
    ...
    kClubInfoVCLine3LabelText = @"Please contact our concierge service by phone number +74956413456 to activate the mobile application";
    kAppMainColor = @"17351E";
    kInformationBackgroundColor = [UIColor colorWithRed:23. / 255 green:53. / 255 blue:30. / 255 alpha:1];
    kFeatureInfoBackgroundColor = [UIColor colorWithRed:4. / 255 green:68. / 255 blue:55. / 255 alpha:1];
    kFeatureInfoNextButtonColor = [UIColor colorWithRed:211. / 255 green:228. / 255 blue:224. / 255 alpha:1];
    kFeatureInfoTextColor = [UIColor colorWithRed:211. / 255 green:228. / 255 blue:224. / 255 alpha:1];
    ...
    kUberActionSheetTopPartColor = kSkolkovoLightGreenColor;
    //Appearance
    [[UITextField appearance] setTintColor:kSkolkovoLightGreenColor];
    [[UITextView appearance] setTintColor:kSkolkovoLightGreenColor];
}
